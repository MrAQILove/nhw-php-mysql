...
<title>Search for Members by Address</title>
			...
			<ul class="nav navbar-nav">
				...
				<li>
					...
					<ul class="dropdown-menu">
						...
						<li class="active"><a href="#"><span class="glyphicon glyphicon-user"></span>&nbsp;Search By Address</a></li>
...
<div class="body-container">
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Search By Address</li>
		</ol>
	</div>
		...
		<table class="table">
			...
			<td>
				<div class="search-container">
					...
					<h1 class="main_title">Search for Members by Address</h1>
					...
					<div class="content">
						<form method="post" id="search-form">
							...
							<div class="form-group">
								<label class="col-md-1 control-label" for="members" style="width: 160px !important;">Member's Address:</label>
							</div>
							<div class="input_container">
								<div class="form-group">
									<input type="text" class="form-control" name="Address" id="Address" placeholder="Search for Member's Address">
								</div>
