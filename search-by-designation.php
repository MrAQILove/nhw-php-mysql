...
<title>Search for Members by Position (Designation)</title>
			...
			<ul class="nav navbar-nav">
				...
				<li>
					...
					<ul class="dropdown-menu">
						...
						<li class="active"><a href="#"><span class="glyphicon glyphicon-user"></span>&nbsp;Search By Position (Designation)</a></li>
...
<div class="body-container">
	<div class="container">
		<!--<div class='alert alert-success'>
			...
			You are here: Home > NHW Members > <strong>SEARCH NHW MEMBERS BY STATE</strong>
		</div>-->
		<ol class="breadcrumb">
			<li><a href="home.php">Home</a></li>
			<li><a href="#">NHW Members</a></li>
			<li class="active">Search By Position (Designation)</li>
		</ol>
	</div>
		...
		<table class="table">
			...
			<td>
				<div class="search-container">
					...
					<h1 class="main_title">Search for Members by Position (Designation)</h1>
					
					<div class="content">
						<form method="post" id="search-form">
							<input type="hidden" name="searchby" id="searchby" value="designation">
							<input type="hidden" name="page" id="page" value="1">
							
							<div class="form-group">
								<label class="col-md-1 control-label" for="members" style="width: 120px !important;">Members in:</label>
							</div>
							<div class="input_container">
								<div class="form-group">
									<select id="DesignationID" class="selectpicker show-tick form-control" data-live-search="false" title="Please select a position ...">
									<?php
									$strSQL = "SELECT * FROM NHW_tblDesignation";
