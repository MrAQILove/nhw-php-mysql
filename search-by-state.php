...
<title>Search for Members by State</title>
			...
			<ul class="nav navbar-nav">
				...
				<li>
					...
					<ul class="dropdown-menu">
						...
						<li class="active"><a href="#"><span class="glyphicon glyphicon-user"></span>&nbsp;Search By State</a></li>
					</ul>
				</li>
				<li>
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
...
<div class="body-container">
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Search By State</li>
		</ol>
	</div>
		...
		<table class="table">
			...
			<td>
				<div class="search-container">
					...
					<h1 class="main_title">Search for Members by State</h1>
					
					<div class="content">
						<form method="post" id="search-form">
							<input type="hidden" name="searchby" id="searchby" value="state">
							...
							<div class="input_container">
								<div class="form-group">
									<select id="StateID" class="selectpicker show-tick form-control" data-live-search="false" title="Please select a state ...">
									<?php
									$strSQL = "SELECT * FROM Members_tblState";
