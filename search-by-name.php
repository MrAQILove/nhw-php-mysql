...
<title>Search for Members by Name 1</title>
			...
			<ul class="nav navbar-nav">
				...
				<li>
					...
					<ul class="dropdown-menu">
						<li class="active"><a href="#"><span class="glyphicon glyphicon-user"></span>&nbsp;Search By Name</a></li>
...
<div class="body-container">
	<div class="container">
		<!--<div class='alert alert-success'>
			...
			You are here: Home > NHW Members > <strong>SEARCH NHW MEMBERS BY ADDRESS</strong>
		</div>-->
		<ol class="breadcrumb">
			<li><a href="home.php">Home</a></li>
		...
		<table class="table">
			...
			<td>
				<div class="search-container">
					...
					<h1 class="main_title">Search for Members by Name 1</h1>
					
					<div class="content">
						<form method="post" id="search-form">
							<input type="hidden" name="searchby" id="searchby" value="firstname">
							<input type="hidden" name="page" id="page" value="1">
							
							
							<div class="form-group">
								<label class="col-md-1 control-label" for="members" style="width: 150px !important;">Member's Name:</label>
							</div>
							<div class="input_container">
								<div class="form-group">
									<input type="text" class="form-control" name="Firstname" id="Firstname" placeholder="Search for Member's Name">
								</div>
